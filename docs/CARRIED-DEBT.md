...
- **Live serving/LoRA run deferred to the operator** (ruling **R-T17-1**, Task 17). The
...
- **vLLM on Blackwell sm_120 is the live run's main risk** (S3 risk, Task 17). This box is an
